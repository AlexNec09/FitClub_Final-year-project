...
import { IMAGES_ATTACHMENTS, IMAGES_PROFILE } from "../config";
...
describe("PostView", () => {
  describe("Layout", () => {
    ...
    it("displays users image", () => {
      ...
      expect(image.src).toContain(IMAGES_PROFILE + "/image1.png");
    });
    ...
    it("sets the attachment path as source for file attachment image", () => {
      ...
      expect(attachmentImage.src).toContain(
        IMAGES_ATTACHMENTS + "/" + postWithAttachment.attachment.name
      );
    });
