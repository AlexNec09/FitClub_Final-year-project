...
describe("PostSubmit", () => {
  ...
  describe("Interactions", () => {
    ...
    it("calls postPost with post request object when clicking Send", () => {
    ...
    it("disables Send button when there is postPost api call", async () => {
      const { queryByText } = setupFocused();
      fireEvent.change(textArea, { target: { value: "Test post content" } });
    ...
    it("enables Send button when postPost api call fails", async () => {
      const { queryByText } = setupFocused();
      fireEvent.change(textArea, { target: { value: "Test post content" } });
    ...
    it("enables Send button after successful postPost action", async () => {
      const { queryByText } = setupFocused();
      fireEvent.change(textArea, { target: { value: "Test post content" } });
    ...
    it("calls postPost with post with file attachment object when clicking Send", async () => {
      const token = jwks.token({});
      const stateWithMockJwt = Object.assign(defaultState, { jwt: token });
